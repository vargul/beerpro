...
public class DetailsViewModel extends ViewModel implements CurrentUser {
    ...
    private final LiveData<FridgeItem> fridgeItems;
    ...
    public DetailsViewModel() {
        ...
        fridgeItems = fridgeRepository.getMyFridgeItemForBeer(currentUserId, getBeer());
    ...
    public LiveData<FridgeItem> getFridgeItems() {
        return fridgeItems;
    }
